...
import com.example.historia_mundi.Models.GeometryModel;
import com.example.historia_mundi.Models.PhotoModel;
...
public class GooglePlaceModel {
    ...
    /**
     * This class, along with the rest of the models, gets information from the RetroFitAPI
     * and sends it the the GooglePlaceModel to "build the different locations
